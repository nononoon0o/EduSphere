...
import { View, TouchableOpacity, Text, Dimensions, ScrollView, PanResponder } from 'react-native';
  ...
  return (
    <View style={{ flex: 1 }} {...panResponder.panHandlers}>
      ...
      <View style={[styles.navigation, { bottom: 100 }]}>
        <NavigationButtons
          onPressPrev={() => router.push('/chapters/Chapter1/chp1/chp1_03/ConceptSummaryScreen')}
          onPressNext={() => router.push('/chapters/Chapter1/chp1/chp1_03/VideoLearningScreen')}
        />
      </View>
    </View>
  );
