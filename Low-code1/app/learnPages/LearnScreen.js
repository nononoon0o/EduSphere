...
import { View, Text, Image, StyleSheet, Dimensions, LayoutRectangle, Pressable, Button, TouchableOpacity, Modal, ScrollView } from 'react-native';
...
const DraggableImage = ({ image, dropZones, droppedImages, onDrop }) => {
