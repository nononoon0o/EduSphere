// app/chapters/Chapter1/Chapter1_01.js
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bullet}>• 물리 변화와 화학 변화를 구분할 수 있다.</Text>
        <Text style={styles.bullet}>• 화학 반응식의 구성 요소를 이해한다.</Text>
        <Text style={styles.bullet}>• 간단한 반응식을 정확하게 쓸 수 있다.</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>🔬 핵심 개념 요약</Text>
        ...
        <Text style={styles.paragraph}>예를 들어, 수소와 산소가 반응하여 물이 되는 반응은 다음과 같이 표현됩니다:</Text>
